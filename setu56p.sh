...
clear
wget -q -O /root/cf.sh "https://raw.githubusercontent.com/KhaiVpn767/v4/main/cf.sh"
chmod +x /root/cf.sh
./cf.sh
elif test $dom -eq 2; then
wget -q -O /root/cf1.sh "https://raw.githubusercontent.com/KhaiVpn767/v4/main/cf1.sh"
chmod +x /root/cf1.sh
./cf1.sh
...
sleep 1
clear
wget https://raw.githubusercontent.com/KhaiVpn767/multi-ws/ipuk/xray/ins-xray.sh && chmod +x ins-xray.sh && ./ins-xray.sh
#wget https://raw.githubusercontent.com/KhaiVpn767/v4/main/xray/ins-xray.sh && chmod +x ins-xray.sh && ./ins-xray.sh
wget https://raw.githubusercontent.com/KhaiVpn767/multi-ws/ipuk/websocket/insshws.sh && chmod +x insshws.sh && ./insshws.sh
